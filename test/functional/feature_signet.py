...
class SignetBasicTest(BitXTestFramework):
    ...
    def test_cli_signetchallenge_hint(self):
        if not self.is_cli_compiled():
            self.log.info("Skipping bitx-cli -signetchallenge hint test")
            return

        self.log.info("Test that bitx-cli hints about -signetchallenge on a signet RPC auth failure")
