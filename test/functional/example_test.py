...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitXTestFramework
    pass


class ExampleTest(BitXTestFramework):
    # Each functional test is a subclass of the BitXTestFramework class.
    ...
    def custom_method(self):
        ...
        BitXTestFramework class so other tests can use it."""
