...
"""Verify that starting bitx with -h works as expected."""

from test_framework.test_framework import BitXTestFramework
from test_framework.util import assert_equal

class HelpTest(BitXTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitx with -h for help text")
        ...
        self.log.info("Start bitx with -version for version information")
        ...
        self.log.info("Start bitxd with -fakearg to make sure it does not start")
