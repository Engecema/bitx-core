...
# Copyright 2016-present The BitX Core developers
...
class ToolUtils(BitXTestFramework):
    ...
    def test_one(self, testObj):
        ...
        if testObj["exec"] == "./bitx-util":
            execrun = self.bins.util_argv() + testObj["args"]
        elif testObj["exec"] == "./bitx-tx":
