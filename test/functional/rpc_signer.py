...
Verify that a bitxd node can use an external signer command.
...
class RPCSignerTest(BitXTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart bitxd with -signer=<cmd>',
