...
class TestBitXIpcCli(BitXTestFramework):
    ...
    def test_cli(self, args, error=None):
        ...
        args = [self.binary_paths.bitxcli, f"-datadir={self.nodes[0].datadir_path}", "-rpcpassword=wrong"] + args + ["echo", "foo"]
