...
"""Test running bitxd with -reindex from a read-only blockstore
...
class BlockstoreReindexTest(BitXTestFramework):
    ...
    def reindex_readonly(self):
        ...
        try:
            ...
            try:
                ...
                undo_immutable_cmd = ['chattr', '-i', filename]
            ...
            try:
                ...
                try:
                    ...
                    undo_immutable_cmd = ['chflags', 'nouchg', filename]
        ...
        if should_reindex:
            ...
            if undo_immutable_cmd is not None:
                subprocess.check_call(undo_immutable_cmd)
