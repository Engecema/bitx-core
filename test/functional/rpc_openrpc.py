#!/usr/bin/env python3
# Copyright (c) 2026 The BitX Core developers
...
class OpenRPCDocTest(BitXTestFramework):
    ...
    def run_test(self):
        ...
        address_description = "A key-value pair. The key (string) is the bitx address, the value (float or string) is the amount in BTC"
        ...
        assert_equal(stats["schema"]["x-bitx-default-hint"], "all values")
        ...
        assert_equal(estimated_feerate["x-bitx-unit"], "amount")
