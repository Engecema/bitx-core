...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/bitx/bitx/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(BitXTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/bitx/bitx/blob/master/doc/tracing.md#tracepoint-validationblock_connected
