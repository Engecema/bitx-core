...
# TestP2PConn: A peer we use to send messages to bitxd, and store responses.
...
class CompactBlocksTest(BitXTestFramework):
    ...
    # This test actually causes bitxd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that bitxd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for bitxd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # bitxd will not send blocktxn responses for blocks whose height is
