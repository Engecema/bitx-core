...
By default, bitxd will dump mempool on shutdown and
...
class MempoolPersistTest(BitXTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitxd from writing mempool.dat to disk. Verify that `savemempool` fails")
