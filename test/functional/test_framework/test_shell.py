...
class TestShell:
    """Wrapper Class for BitXTestFramework.

    The TestShell class extends the BitXTestFramework
    ...
    class __TestShell(BitXTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BitXTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # BitXTestFramework instances are supposed to be constructed with the path
