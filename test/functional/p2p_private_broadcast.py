...
class P2PPrivateBroadcast(BitXTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-32601, "Private broadcast is not enabled. Ensure you're running BitX Core with -privatebroadcast=1.",
        ...
        # Stop the SOCKS5 proxy server to avoid it being upset by the bitx
        ...
        self.restart_node(0, extra_args=[
            ...
            # BitX Core to start, hoping/assuming that the location of the Tor proxy
