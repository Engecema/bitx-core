...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The bitxd node closes feeler connections as soon as a version
...
class P2PAddConnections(BitXTestFramework):
    ...
    def run_test(self):
        ...
        # bitxd behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that bitxd sends its own version prior to processing
