...
maintained:
* for `src/crc32c`: https://github.com/bitx-core/crc32c-subtree.git (branch bitx-fork)
* for `src/crypto/ctaes`: https://github.com/bitx-core/ctaes.git (branch master)
* for `src/ipc/libmultiprocess`: https://github.com/bitx-core/libmultiprocess (branch master)
* for `src/leveldb`: https://github.com/bitx-core/leveldb-subtree.git (branch bitx-fork)
* for `src/minisketch`: https://github.com/bitx-core/minisketch.git (branch master)
* for `src/secp256k1`: https://github.com/bitx-core/secp256k1.git (branch master)
...
```
git remote add --fetch secp256k1 https://github.com/bitx-core/secp256k1.git
```
