...
complete --command bitxd --no-files

# Extract options
function __fish_bitxd_get_options
...
complete \
    --command bitxd \
    --arguments "(__fish_bitxd_get_options --nofiles)"
