...
# Extract options
function __fish_bitx_tx_get_options
...
# Extract commands
function __fish_bitx_tx_get_commands
...
complete \
    --command bitx-tx \
    --condition "not __fish_bitx_seen_cmd (__fish_bitx_tx_get_commands --commandsonly)" \
    --arguments "(__fish_bitx_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command bitx-tx \
    --arguments "(__fish_bitx_tx_get_commands)" \
    --no-files
