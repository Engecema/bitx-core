...
declare -A LIBS
LIBS[cli]="libbitx_cli.a"
LIBS[common]="libbitx_common.a"
LIBS[consensus]="libbitx_consensus.a"
LIBS[crypto]="libbitx_crypto.a"
LIBS[node]="libbitx_node.a"
LIBS[util]="libbitx_util.a"
LIBS[wallet]="libbitx_wallet.a"
...
# https://github.com/bitx/bitx/issues/10102
