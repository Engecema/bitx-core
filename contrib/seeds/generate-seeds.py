...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('// Copyright (c) The BitX Core developers\n')
    ...
    g.write('#ifndef BITX_CHAINPARAMSSEEDS_H\n')
    g.write('#define BITX_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the bitx network\n')
    ...
    g.write('#endif // BITX_CHAINPARAMSSEEDS_H\n')
