# Bootstrappable BitX Core Builds

This directory contains the files necessary to perform bootstrappable BitX
Core builds.
...
To build BitX Core reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/bitx-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/bitx-core/guix.sigs).
