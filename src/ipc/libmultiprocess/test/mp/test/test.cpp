...
{
    // Regression test for bitx/bitx#34711, bitx/bitx#34756 where a
...
{
    // Regression test for bitx/bitx#34777 heap-use-after-free where
...
{
    // Regression test for bitx/bitx#34782 stack-use-after-return where
...
{
    // Regression test for bitx-core/libmultiprocess#219 where
