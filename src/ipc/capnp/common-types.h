...
#ifndef BITX_IPC_CAPNP_COMMON_TYPES_H
#define BITX_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between bitx processes.
...
//! Functions to serialize / deserialize common bitx types.
namespace mp {
...
#endif // BITX_IPC_CAPNP_COMMON_TYPES_H
