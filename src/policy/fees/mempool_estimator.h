...
#ifndef BITX_POLICY_FEES_MEMPOOL_ESTIMATOR_H
#define BITX_POLICY_FEES_MEMPOOL_ESTIMATOR_H
 ...
 *
 * Uses BitX Core's block-building algorithm to generate a block template from the mempool,
...
#endif // BITX_POLICY_FEES_MEMPOOL_ESTIMATOR_H
