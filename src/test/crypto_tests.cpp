...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("As BitX relies on 80 byte header hashes, we want to have an example for that.",
...
BOOST_AUTO_TEST_CASE(poly1305_testvector)
{
    ...
    // Tests from httpshttps://github.com/floodyberry/poly1305-donna/blob/master/poly1305-donna.c
