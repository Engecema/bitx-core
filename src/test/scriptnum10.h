...
#ifndef BITX_TEST_SCRIPTNUM10_H
#define BITX_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BitX Core 0.10.0, for cross-comparison.
 */
public:
