...
#ifndef BITX_TEST_UTIL_LOGGING_H
#define BITX_TEST_UTIL_LOGGING_H
...
#define ASSERT_DEBUG_LOG(message) DebugLogHelper BITX_UNIQUE_NAME(debugloghelper)(message)

#endif // BITX_TEST_UTIL_LOGGING_H
