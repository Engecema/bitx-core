...
#ifndef BITX_TEST_UTIL_SETUP_COMMON_H
#define BITX_TEST_UTIL_SETUP_COMMON_H
...
struct BasicTestingSetup {
     ...
     * test environments.
     *
     * @see https://github.com/issues/25055 for additional context.
     */
    ArgsManager m_args;
};
...
#endif // BITX_TEST_UTIL_SETUP_COMMON_H
