...
{
    BOOST_CHECK(TestSplitHost("www.bitxcore.org", "www.bitxcore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.bitxcore.org]", "www.bitxcore.org", 0));
    BOOST_CHECK(TestSplitHost("www.bitxcore.org:80", "www.bitxcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitxcore.org]:80", "www.bitxcore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.bitxcore.org:65536", "www.bitxcore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.bitxcore.org:0", "www.bitxcore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.bitxcore.org:", "www.bitxcore.org:", 0, false));
}
