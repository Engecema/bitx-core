...
#ifndef BITX_TXMEMPOOL_H
#define BITX_TXMEMPOOL_H
 ...
 * BitX-specific logic. Specifically, TxGraph handles (for each transaction)
 ...
 *
 * CTxMemPool itself handles the BitX-specific parts of mempool
