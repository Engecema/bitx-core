...
#ifndef BITX_NODE_CONNECTION_TYPES_H
#define BITX_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/bitx-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on BitX’s Peer-to-Peer Network")
...
#endif // BITX_NODE_CONNECTION_TYPES_H
