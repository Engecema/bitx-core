...
{
    // Test regression https://github.com/issues/24457. Ensure
...
{
    // Test that the bug httpshttps://github.com/bitx-core/gui/issues/567 does not resurface.
    // It was fixed via httpshttps://github.com/bitx-core/gui/pull/568.
    // With fListen=false in ~/.config/BitX/BitX-Qt.conf and all else left as default,
    // bitx-qt should set both -listen and -listenonion to false and start successfully.
