...
//! Entry point for BitXApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BitXApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BitXGUI tests.
void AppTests::guiTests(BitXGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BitXGUI::consoleShown, this, &AppTests::consoleTests);
