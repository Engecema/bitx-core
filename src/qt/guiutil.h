...
#ifndef BITX_QT_GUIUTIL_H
#define BITX_QT_GUIUTIL_H
...
/** Utility functions used by the BitX Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bitx:" URI into recipient object, return true on successful parsing
