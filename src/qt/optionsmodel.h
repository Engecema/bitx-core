...
#ifndef BITX_QT_OPTIONSMODEL_H
#define BITX_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for BitX client.
...
public:
    ...
    BitXUnit getDisplayUnit() const { return m_display_bitx_unit; }
...
Q_SIGNALS:
    void displayUnitChanged(BitXUnit unit);
