      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->bitxAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bitxAtStartup);
    ...
    ui->bitxAtStartup->setToolTip(ui->bitxAtStartup->toolTip().arg(CLIENT_NAME));
    ui->bitxAtStartup->setText(ui->bitxAtStartup->text().arg(CLIENT_NAME));

    ui->openBitXConfButton->setToolTip(ui->openBitXConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new BitXUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitxAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitXConfButton_clicked()
{
