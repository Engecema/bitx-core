...
#ifndef BITX_QT_BITXGUI_H
#define BITX_QT_BITXGUI_H
...
/**
  BitX GUI main class. This class represents the main window of the BitX UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BitXGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BitXGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~BitXGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a bitx wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, BitXUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed BitX Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(BitXUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // BITX_QT_BITXGUI_H
