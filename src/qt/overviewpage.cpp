...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = BitXUnits::formatWithUnit(unit, amount, true, BitXUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
...
{
    BitXUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(BitXUnits::formatWithPrivacy(unit, balances.balance, BitXUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(BitXUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, BitXUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(BitXUnits::formatWithPrivacy(unit, balances.immature_balance, BitXUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(BitXUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, BitXUnits::SeparatorStyle::ALWAYS, m_privacy));
