...
<context>
    ...
    <message>
        ...
        <translation>Επιλέξτε τη διεύθυνση αποστολής των νομισμάτων σας</translation>
    </message>
    <message>
        <source>Comma separated file</source>
        <extracomment>Expanded name of the CSV file format. See: https://en.wikipedia.org/wiki/Comma-separated_values.</extracomment>
        <translation>Αρχείο οριοθετημένο με κόμμα</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Διευθύνσεις λήψης - %1</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Διευθύνσεις αποστολής - %1</translation>
    </message>
    <message>
...
Signing is only possible with addresses of the type 'legacy'.</source>
        <translation>Αυτές είναι οι BitX διευθύνσεις για την λήψη πληρωμών. Χρησιμοποιήστε το κουμπί  'Δημιουργία νέας διεύθυνσης λήψεων' στο παράθυρο λήψεων για την δημιουργία νέας διεύθυνσης.
Η υπογραφή είναι διαθέσιμη μόνο σε διευθύνσεις 'παλαιού τύπου'.</translation>
    ...
    <message>
        ...
        <translation>Αυτές είναι οι διευθύνσεις BitX σας για την αποστολή πληρωμών. Να ελέγχετε πάντα το ποσό, καθώς και τη διεύθυνση παραλήπτη, πριν στείλετε νομίσματα.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Πληκτρολογήστε τον παλιό και τον νέο κωδικό σας πρόσβασης για το πορτοφόλι.</translation>
    </message>
    <message>
        <source>IMPORTANT: Any previous backups you have made of your wallet file should be replaced with the newly generated, encrypted wallet file. For security reasons, previous backups of the unencrypted wallet file will become useless as soon as you start using the new, encrypted wallet.</source>
        <translation>ΣΗΜΑΝΤΙΚΟ: Τα προηγούμενα αντίγραφα ασφαλείας που έχετε κάνει από το αρχείο του πορτοφόλιου σας θα πρέπει να αντικατασταθούν με το νέο κρυπτογραφημένο αρχείο πορτοφολιού που δημιουργείται. Για λόγους ασφαλείας, τα προηγούμενα αντίγραφα ασφαλείας του μη κρυπτογραφημένου αρχείου πορτοφολιού θα καταστούν άχρηστα μόλις αρχίσετε να χρησιμοποιείτε το νέο κρυπτογραφημένο πορτοφόλι.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Θυμίσου ότι το να κρυπτογραφείς το πορτοφόλι σου δεν μπορεί να προστατέψει πλήρως τα bitxs σου από κλοπή από  κακόβουλο λογισμικό που έχει μολύνει τον υπολογιστή σου</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Η παλιά φράση πρόσβασης που εισήχθη για την αποκρυπτογράφηση του πορτοφολιού είναι εσφαλμένη. Περιέχει έναν χαρακτήρα null (δηλαδή ένα μηδενικό byte). Εάν η φράση πρόσβασης είχε οριστεί με έκδοση αυτού του λογισμικού προγενέστερη της 25.0, δοκιμάστε ξανά εισάγοντας μόνο τους χαρακτήρες έως — αλλά όχι συμπεριλαμβανομένου — του πρώτου χαρακτήρα null.</translation>
    </message>
    <message>
        <source>The passphrase entered for the wallet decryption is incorrect. It contains a null character (ie - a zero byte). If the passphrase was set with a version of this software prior to 25.0, please try again with only the characters up to — but not including — the first null character. If this is successful, please set a new passphrase to avoid this issue in the future.</source>
        <translation>Η φράση πρόσβασης που εισήχθη για την αποκρυπτογράφηση του πορτοφολιού είναι εσφαλμένη. Περιέχει έναν μηδενικό χαρακτήρα (δηλαδή - ένα byte μηδέν). Εάν η φράση πρόσβασης ορίστηκε με μια έκδοση αυτού του λογισμικού πριν από την 25.0, δοκιμάστε ξανά μόνο με τους χαρακτήρες έως — αλλά χωρίς να συμπεριλαμβάνεται — ο πρώτος μηδενικός χαρακτήρας. Εάν αυτό είναι επιτυχές, ορίστε μια νέα φράση πρόσβασης για να αποφύγετε αυτό το ζήτημα στο μέλλον.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Αυτή η ενέργεια απαιτεί τον κωδικό πρόσβασης του πορτοφολιού για να ξεκλειδώσει το πορτοφόλι.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Προσοχή! Εάν κρυπτογραφήσεις το πορτοφόλι σου και χάσεις τον κωδικό πρόσβασης, θα &lt;b&gt; ΧΑΣΕΙΣ ΟΛΑ ΣΟΥ ΤΑ BITXS &lt;/b&gt;!</translation>
    </message>
    <message>
        <source>Warning: The Caps Lock key is on!</source>
        <translation>Προειδοποίηση: Το πλήκτρο Caps Lock είναι ενεργό!</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Το πορτοφόλι σου έχει τώρα κρυπτογραφηθεί.</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Απαγόρευση έως</translation>
    </message>
    </context>
<context>
    ...
    <message>
        ...
        <translation>Συνέβη ένα μοιραίο σφάλμα. %1 δεν μπορεί πλέον να συνεχίσει με ασφάλεια και θα τερματιστεί.</translation>
    </message>
    <message>
        <source>An internal error occurred. %1 will attempt to continue safely. This is an unexpected bug which can be reported as described below.</source>
        <translation>Προέκυψε ένα εσωτερικό σφάλμα. Το %1 θα επιχειρήσει να συνεχίσει με ασφάλεια. Αυτό είναι ένα απροσδόκητο σφάλμα, το οποίο μπορείτε να αναφέρετε όπως περιγράφεται παρακάτω.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Το αρχείο ρυθμίσεων %1 ενδέχεται να είναι κατεστραμμένο ή μη έγκυρο.</translation>
    </message>
</context>
<context>
    <name>BitXGUI</name>
    ...
    <message>
        ...
        <translation>Φτάνει...</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Κάντε κλικ για περισσότερες ενέργειες.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Απενεργοποίηση δραστηριότητας δικτύου</translation>
    </message>
    <message>
        <source>E&amp;xit</source>
    ...
    <message>
        ...
        <translation>Ενεργοποίηση δραστηριότητας δικτύου</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Φόρτωσε PSBT από &amp;πρόχειρο...</translation>
    </message>
    <message>
        <source>Load Partially Signed BitX Transaction</source>
        <translation>Φόρτωση συναλλαγής Partially Signed BitX</translation>
    </message>
    <message>
        <source>Load Partially Signed BitX Transaction from clipboard</source>
        <translation>Φόρτωση συναλλαγής Partially Signed BitX από το πρόχειρο</translation>
    </message>
    <message>
        <source>Load Wallet Backup</source>
        <extracomment>The title for Restore Wallet File Windows</extracomment>
        <translation>Φόρτωση Αντίγραφου Ασφαλείας Πορτοφολιού</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Μετεγκατάσταση Πορτοφολιού</translation>
    </message>
    <message>
        <source>Migrate a wallet</source>
        <translation>Μετεγκατάσταση ενός πορτοφολιού</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ανοίξτε ένα bitx: URI</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Προ-συγχρονισμός Επικεφαλίδων (%1%)...</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Αίτηση πληρωμών (δημιουργεί QR codes και διευθύνσεις bitx: )</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Επαναφορά ενός πορτοφολιού από ένα αρχείο αντίγραφου ασφαλείας</translation>
    </message>
    <message>
        <source>S&amp;how</source>
    ...
    <message>
        ...
        <translation>Στείλε νομίσματα σε μια διεύθυνση bitx</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Προβολή καρτέλας Κόμβων</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Εμφάνισε το %1 βοηθητικό μήνυμα για λήψη μιας λίστας με διαθέσιμες επιλογές για BitX εντολές </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ελέγξτε τα μηνύματα για να βεβαιωθείτε ότι υπογράφηκαν με τις καθορισμένες διευθύνσεις BitX</translation>
    </message>
    <message>
        <source>Wallet Data</source>
        <extracomment>Name of the wallet data file format.</extracomment>
        <translation>Δεδομένα πορτοφολιού</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>&amp;Ξεκλείδωμα διαθέσιμου υπολοίπου</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Αδυναμία απαρίθμησης υπογραφέων</translation>
    </message>
    <message>
        <source>Create Wallet</source>
    ...
    <message>
        ...
        <translation>Αποτυχία δημιουργίας πορτοφολιού</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Βρέθηκαν πάρα πολλοί εξωτερικοί υπογράφοντες</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Συντάχθηκε χωρίς την υποστήριξη εξωτερικής υπογραφής (απαιτείται για εξωτερική υπογραφή)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Εξωτερικός υπογραφέας</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Παρακαλώ εισαγάγετε ένα όνομα και, εάν θέλετε, ενεργοποιήστε τυχόν προηγμένες επιλογές</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Απέχετε ένα βήμα από τη δημιουργία του νέου σας πορτοφολιού!</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Η διεύθυνση "%1" δεν είναι έγκυρη BitX διεύθυνση.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Το %1 θα κατεβάσει και θα αποθηκεύσει ένα αντίγραφο της αλυσίδας μπλοκ BitX.</translation>
    </message>
    <message numerus="yes">
        <source>%n GB of space available</source>
        <translation><numerusform>%n GB of space available</numerusform><numerusform>%n GB διαθέσιμου χώρου</numerusform></translation>
    </message>
    <message numerus="yes">
    ...
    <message>
        ...
        <translation>Επιλογή φακέλου δεδομένων</translation>
    </message>
    <message>
        <source>Error</source>
        <translation>Σφάλμα</translation>
    ...
    <message>
        ...
        <translation>Περιόρισε την χωρητικότητα της αλυσίδας block σε</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Το πορτοφόλι θα αποθηκευτεί κι αυτό σε αυτόν τον κατάλογο.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Αφού πατήσετε OK, το %1 θα ξεκινήσει τη λήψη και την επεξεργασία της πλήρους αλυσίδας μπλοκ %4 (%2GB) ξεκινώντας με τις πρώτες συναλλαγές στο %3 όταν πρωτο-ξεκίνησε το %4.</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Φόρτωσε Πορτοφόλια</translation>
    </message>
    <message>
        <source>Loading wallets…</source>
        <extracomment>Descriptive text of the load wallets progress window which indicates to the user that wallets are currently being loaded.</extracomment>
        <translation>Φόρτωση πορτοφολιών...</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Μετεγκατάσταση Πορτοφολιού &lt;b&gt;%1&lt;/b&gt;…</translation>
    </message>
    <message>
...
Η διαδικασία μετεγκατάστασης θα δημιουργήσει ένα αντίγραφο ασφαλείας του πορτοφολιού πριν από τη μετεγκατάσταση. Αυτό το αρχείο αντιγράφου ασφαλείας θα ονομάζεται &lt;wallet name&gt;-&lt;timestamp&gt;.legacy.bak και μπορεί να βρεθεί στον φάκελο αυτού του πορτοφολιού. Σε περίπτωση εσφαλμένης μετεγκατάστασης, το αντίγραφο ασφαλείας μπορεί να επαναφερθεί με τη λειτουργία "Επαναφορά Πορτοφολιού".</translation>
    ...
    <message>
        ...
        <translation>Επιτυχής Μετεγκατάσταση</translation>
    </message>
    <message>
        <source>Migration failed</source>
        <translation>Αποτυχία μετεγκατάστασης</translation>
    </message>
    <message>
        <source>Restore Wallet</source>
    ...
    <message>
        ...
        <translation>Το πορτοφόλι '%1' μετεγκαταστάθηκε επιτυχώς.</translation>
    </message>
    <message>
        <source>Watchonly scripts have been migrated to a new wallet named '%1'.</source>
        <translation>Τα scripts παρακολούθησης μετεγκαταστάθηκαν σε νέο πορτοφόλι ονόματι '%1'.</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Η προσπάθεια να δαπανήσετε bitxs που επηρεάζονται από τις μη εμφανιζόμενες ακόμη συναλλαγές δεν θα γίνει αποδεκτή από το δίκτυο.</translation>
    </message>
    <message>
        <source>Esc</source>
    ...
    <message>
        ...
        <translation>Οι πρόσφατες συναλλαγές ενδέχεται να μην είναι ακόμα ορατές και επομένως η ισορροπία του πορτοφολιού σας μπορεί να είναι εσφαλμένη. Αυτές οι πληροφορίες θα είναι σωστές όταν ολοκληρωθεί το συγχρονισμό του πορτοφολιού σας με το δίκτυο BitX, όπως περιγράφεται παρακάτω.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Ανοίξτε το bitx URI</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Προειδοποίηση ανοίγματος πορτοφολιού</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>&amp;Διαδρομή script εξωτερικού υπογραφέα</translation>
    </message>
    <message>
        <source>&amp;Main</source>
    ...
    <message>
        ...
        <translation>&amp;Διευθύνσεις URL συναλλαγών τρίτων</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ανοίξτε αυτόματα τη πόρτα του BitX client στο router. Αυτό λειτουργεί μόνο όταν το router σας υποστηρίζει PCP ή NAT-PMP και είναι ενεργοποιημένο. Η εξωτερική πόρτα μπορεί να είναι τυχαία.</translation>
    </message>
    <message>
...
Επιλογές διαμόρφωσης</translation>
    ...
    <message>
        ...
        <translation>Σύνδεση στο δίκτυο BitX μέσω διαμεσολαβητή SOCKS5.</translation>
    </message>
    <message>
        <source>Connect to the BitX network through a separate SOCKS5 proxy for Tor onion services.</source>
        <translation>Συνδεθείτε στο δίκτυο BitX μέσω ενός ξεχωριστού διακομιστή μεσολάβησης SOCKS5 για τις onion υπηρεσίες του Tor.</translation>
    </message>
    <message>
        <source>Continue</source>
        <translation>Συνεχίστε</translation>
    ...
    <message>
        ...
        <translation>Θα δημιουργηθούν αντίγραφα ασφαλείας για τις τρέχουσες ρυθμίσεις στο "%1".</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ενεργοποίηση διακομιστή R&amp;PC</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Γραμματοσειρά στην καρτέλα Επισκόπηση:</translation>
    </message>
    <message>
        <source>Full path to a %1 compatible script (e.g. C:\Downloads\hwi.exe or /Users/you/Downloads/hwi.py). Beware: malware can steal your coins!</source>
        <translation>Πλήρης διαδρομή ενός script συμβατού με το %1 (π.χ.: C:\Downloads\hwi.exe ή /Users/you/Downloads/hwi.py). Προσοχή: ένα κακόβουλο λογισμικό μπορεί να κλέψει τα bitx σας!</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Δρομολόγηση θύρας με χρήση PCP ή NA&amp;T-PMP</translation>
    </message>
    <message>
        ...
        <translation>Μέγιστο μέγεθος προσωρινής μνήμης βάσης δεδομένων. Βεβαιωθείτε ότι έχετε αρκετή μνήμη RAM. Μια μεγαλύτερη προσωρινή μνήμη μπορεί να συμβάλει σε ταχύτερο συγχρονισμό, μετά τον οποίο το όφελος είναι λιγότερο έντονο στις περισσότερες περιπτώσεις. Η μείωση του μεγέθους της προσωρινής μνήμης θα μειώσει τη χρήση μνήμης. Η αχρησιμοποίητη μνήμη mempool είναι κοινόχρηστη για αυτήν την προσωρινή μνήμη.</translation>
    </message>
    <message>
        <source>MiB</source>
    ...
    <message>
        ...
        <translation>Οι επιλογές που έχουν οριστεί σε αυτό το παράθυρο διαλόγου παραβλέπονται από τη γραμμή εντολών:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Αφαίρεση &amp;τέλους συναλλαγής από το ποσό κατά προεπιλογή</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Διευθύνσεις URL τρίτων (π.χ. block explorer) που εμφανίζονται στην καρτέλα συναλλαγών ως συμφραζόμενα στοιχεία μενού. %s στο URL αντικαθίσταται από το hash της συναλλαγής. Πολλαπλές διευθύνσεις URL διαχωρίζονται με κάθετη γραμμή |.</translation>
    </message>
    <message>
        <source>This allows you or a third party tool to communicate with the node through command-line and JSON-RPC commands.</source>
        <extracomment>Tooltip text for Options window setting that enables the RPC server.</extracomment>
        <translation>Αυτό επιτρέπει σε εσάς ή ένα εργαλείο τρίτων να επικοινωνεί με τον κόμβο μέσω κώδικα γραμμής εντολών και JSON-RPC.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Αν θα οριστεί η αφαίρεση τέλους συναλλαγής από το ποσό ως προεπιλογή ή όχι.</translation>
    </message>
    <message>
        <source>Whether to show PSBT controls.</source>
        <extracomment>Tooltip text for options window setting that enables PSBT controls.</extracomment>
        <translation>Αν θα εμφανιστούν στοιχεία ελέγχου PSBT.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Δεν μπορεί να διαβαστεί η ρύθμιση "%1", %2.</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Ανώριμα:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Οι πληροφορίες που εμφανίζονται μπορεί να είναι ξεπερασμένες. Το πορτοφόλι σας συγχρονίζεται αυτόματα με το δίκτυο BitX μετά από μια σύνδεση, αλλά αυτή η διαδικασία δεν έχει ακόμη ολοκληρωθεί.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Δεν είναι δυνατή η υπογραφή περισσότερων καταχωρήσεων.</translation>
    </message>
    <message>
...
ID Συναλλαγής: %1</translation>
    ...
    <message>
        ...
        <translation>Η συναλλαγή απαιτεί υπογραφή/ές</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Το 'bitx://' δεν είναι έγκυρο URI. Αντ' αυτού χρησιμοποιήστε το 'bitx:'.</translation>
    </message>
    <message>
        <source>Cannot start bitx: click-to-pay handler</source>
        <translation>Δεν είναι δυνατή η εκκίνηση του bitx: χειριστής click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Δεν είναι δυνατή η ανάλυση του URI! Αυτό μπορεί να προκληθεί από μη έγκυρη διεύθυνση BitX ή παραμορφωμένες παραμέτρους URI.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Το %1 δεν πραγματοποίησε ασφαλή έξοδο ακόμη...</translation>
    </message>
    <message numerus="yes">
    ...
    <message>
        ...
        <translation>Προεπιλεγμένη γραμματοσειρά συστήματος "%1"</translation>
    </message>
    <message>
        <source>Do you want to reset settings to default values, or to abort without making changes?</source>
        <extracomment>Explanatory text shown on startup when the settings file cannot be read. Prompts user to make a choice between resetting or aborting.</extracomment>
        <translation>Θέλετε να επαναφέρετε τις ρυθμίσεις στις προεπιλεγμένες τους τιμές, ή να αποχωρήσετε χωρίς να κάνετε αλλαγές;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Εισάγετε μια διεύθυνση BitX (π.χ. %1)</translation>
    </message>
    <message>
        <source>Error: %1</source>
        <translation>Σφάλμα: %1</translation>
...
<context>
    ...
    <message>
        ...
        <translation>&amp;Αντιγραφή IP/Netmask</translation>
    </message>
    <message>
        <source>&amp;Copy address</source>
    ...
    <message>
        ...
        <translation>(κόμβος: %1)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>1 η&amp;μέρα</translation>
    </message>
    <message>
...
Εκτελέστε εντολή χρησιμοποιώντας το πορτοφόλι "%1"</translation>
    ...
    <message>
        ...
        <translation>Απόκρυψη Λεπτομερειών Κόμβων</translation>
    </message>
    <message>
        <source>In:</source>
    ...
    <message>
        ...
        <translation>Τοπικές Διευθύνσεις</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Διευθύνσεις δικτύου που χρησιμοποιεί αυτήν τη στιγμή ο BitX κόμβος σας για να επικοινωνεί με άλλους κόμβους.</translation>
    </message>
    <message>
        <source>Never</source>
    ...
    <message>
        ...
        <translation>Παράθυρο κόμβου - [%1]</translation>
    </message>
    <message>
        <source>None</source>
        <translation>Κανένα</translation>
    ...
    <message>
        ...
        <translation>Αναμονή Ping</translation>
    </message>
    <message>
        <source>Received</source>
        <translation>Παραλήφθησαν</translation>
    ...
    <message>
        ...
        <translation>Επιλέξτε έναν χρήστη για να δείτε αναλυτικές πληροφορίες.</translation>
    </message>
    <message>
        <source>Sent</source>
        <translation>Αποστολή</translation>
    ...
    <message>
        ...
        <translation>Αναγνωριστικό περιόδου σύνδεσης</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Η συμβολοσειρά αναγνωριστικού περιόδου σύνδεσης BIP324 σε δεκαεξαδική μορφή.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Έκδοση πρωτοκόλλου μεταφοράς: %1</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Αναμετάδοση Συναλλαγής</translation>
    </message>
    <message>
...
%7ΠΡΟΕΙΔΟΠΟΙΗΣΗ: Οι απατεώνες/scammers είναι ενεργοί, λέγοντας στους χρήστες να πληκτρολογούν εντολές εδώ, κλέβοντας το περιεχόμενο του πορτοφολιού τους. Μην χρησιμοποιείτε αυτήν την κονσόλα χωρίς να κατανοήσετε πλήρως τις συνέπειες μιας εντολής.%8</translation>
    ...
    <message>
        ...
        <translation>Αν αναμεταδίδουμε συναλλαγές σε αυτόν τον κόμβο.</translation>
    </message>
    <message>
        <source>Yes</source>
    ...
    <message>
        ...
        <translation>ανίχνευση: ο κόμβος μπορεί να είναι v1 ή v2</translation>
    </message>
    <message>
        <source>no high bandwidth relay selected</source>
        <translation>δεν επιλέχθηκε υψηλού εύρους ζώνη αναμετάδοσης</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>v2: BIP324 κρυπτογραφημένο πρωτόκολλο μεταφοράς</translation>
    </message>
    <message>
        <source>via %1</source>
...
<context>
    ...
    <message>
        ...
        <translation>Ένα προαιρετικό μήνυμα που επισυνάπτεται στο αίτημα πληρωμής, το οποίο θα εμφανιστεί όταν το αίτημα ανοίξει. Σημείωση: Το μήνυμα δεν θα αποσταλεί με την πληρωμή μέσω του δικτύου BitX.</translation>
    </message>
    <message>
        <source>Base58 (Legacy)</source>
        <translation>Base58 (Παλαιού τύπου)</translation>
    </message>
    <message>
        <source>Bech32m (BIP-350) is an upgrade to Bech32, wallet support is still limited.</source>
        <translation>Το Bech32m (BIP-350) είναι μια αναβάθμιση στο Bech32, η υποστήριξη πορτοφολιού εξακολουθεί να είναι περιορισμένη.</translation>
    </message>
    <message>
        <source>Clear</source>
    ...
    <message>
        ...
        <translation>Δημιουργεί μια εγγενή διεύθυνση segwit (BIP-173). Ορισμένα παλιά πορτοφόλια δεν το υποστηρίζουν.</translation>
    </message>
    <message>
        <source>Generates an address compatible with older wallets.</source>
        <translation>Δημιουργεί μια διεύθυνση συμβατή με παλαιότερα πορτοφόλια.</translation>
    </message>
    <message>
        <source>Not recommended due to higher fees and less protection against typos.</source>
        <translation>Δεν συνιστάται λόγω υψηλότερων χρεώσεων και μικρότερης προστασίας έναντι τυπογραφικών σφαλμάτων.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Επιβεβαιώστε την διεύθυνση με π.χ την οθόνη της συσκευής πορτοφολιού</translation>
    </message>
    <message>
        <source>Wallet:</source>
        <translation>Πορτοφόλι</translation>
...
<context>
    ...
    <message>
        ...
        <translation>Αποτυχία επαναφοράς πορτοφολιού</translation>
    </message>
    <message>
        <source>Restore wallet message</source>
        <extracomment>Title of message box which is displayed when the wallet is successfully restored.</extracomment>
        <translation>Μήνυμα επαναφοράς πορτοφολιού</translation>
    </message>
    <message>
        <source>Restore wallet warning</source>
        <extracomment>Title of message box which is displayed when the wallet is restored with some warning.</extracomment>
        <translation>Προειδοποίηση επαναφοράς πορτοφολιού</translation>
    </message>
    </context>
<context>
    ...
    <message>
        ...
        <translation>%1 από το πορτοφόλι '%2'</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>(Η έξυπνη χρέωση δεν έχει αρχικοποιηθεί ακόμη. Αυτό συνήθως παίρνει κάποια μπλοκ...)</translation>
    </message>
    <message>
        <source>(no label)</source>
        <translation>(χωρίς ετικέτα)</translation>
    ...
    <message>
        ...
        <translation>Θέλετε να δημιουργήσετε αυτήν τη συναλλαγή;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Εξωτερικό υπόλοιπο:</translation>
    </message>
    <message>
        <source>External signer failure</source>
        <extracomment>"External signer" means using devices such as hardware wallets.</extracomment>
        <translation>Αποτυχία εξωτερικού υπογραφέα</translation>
    </message>
    <message>
    ...
    <message>
        <source>PSBT saved to disk</source>
        <translation>Το PSBT αποθηκεύτηκε στον δίσκο</translation>
    </message>
    <message>
        ...
        <translation>Παρακαλούμε, ελέγξτε την πρόταση συναλλαγής. Θα παραχθεί μια συναλλαγή BitX με μερική υπογραφή (PSBT), την οποία μπορείτε να αντιγράψετε και στη συνέχεια να υπογράψετε με π.χ. ένα πορτοφόλι %1 εκτός σύνδεσης ή ένα πορτοφόλι υλικού συμβατό με το PSBT.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Παρακαλώ, ελέγξτε τη συναλλαγή σας. Μπορείτε να δημιουργήσετε και να στείλετε αυτήν τη συναλλαγή ή να δημιουργήσετε μια μερικώς υπογεγραμμένη συναλλαγή BitX (PSBT), την οποία μπορείτε να αποθηκεύσετε ή να αντιγράψετε και στη συνέχεια να υπογράψετε, π.χ. με ένα πορτοφόλι εκτός σύνδεσης %1 ή ένα hardware πορτοφόλι συμβατό με PSBT.</translation>
    </message>
    <message>
        <source>Quantity:</source>
        <translation>Ποσότητα:</translation>
...
Note:  Since the fee is calculated on a per-byte basis, a fee rate of "100 satoshis per kvB" for a transaction size of 500 virtual bytes (half of 1 kvB) would ultimately yield a fee of only 50 satoshis.</source>
        <translation>Καθορίστε μία εξατομικευμένη χρέωση ανά kB (1.000 bytes) του εικονικού μεγέθους της συναλλαγής.
...
Σημείωση: Εφόσον η χρέωση υπολογίζεται ανά byte, ένας ρυθμός χρέωσης των «100 satoshis ανά kvB» για μέγεθος συναλλαγής 500 ψηφιακών bytes (το μισό του 1 kvB) θα απέφερε χρέωση μόλις 50 satoshis.</translation>
    ...
    <message>
        ...
        <translation>Το PSBT αντιγράφηκε στο πρόχειρο. Μπορείτε, επίσης, να το αποθηκεύσετε.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ανυπόγραφη Συναλλαγή</translation>
    </message>
    <message>
...
Προειδοποίηση: Προς το παρόν δεν είναι δυνατή η εκτίμηση των εξόδων..</translation>
    ...
    <message>
        ...
        <translation>Προειδοποίηση: Μη έγκυρη διεύθυνση BitX</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Όταν υπάρχει λιγότερος όγκος συναλλαγών από το χώρο στα μπλοκ, οι ανθρακωρύχοι καθώς και οι κόμβοι αναμετάδοσης μπορούν να επιβάλουν ένα ελάχιστο τέλος. Η πληρωμή μόνο αυτού του ελάχιστου τέλους είναι μια χαρά, αλλά γνωρίζετε ότι αυτό μπορεί να οδηγήσει σε μια συναλλαγή που δεν επιβεβαιώνει ποτέ τη στιγμή που υπάρχει μεγαλύτερη ζήτηση για συναλλαγές bitx από ό, τι μπορεί να επεξεργαστεί το δίκτυο.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Ένα μήνυμα που επισυνάφθηκε στο bitx: URI το οποίο θα αποθηκευτεί με τη συναλλαγή για αναφορά. Σημείωση: Αυτό το μήνυμα δεν θα σταλεί μέσω του δικτύου BitX.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Η διεύθυνση BitX που θα σταλεί η πληρωμή</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Το τέλος θα αφαιρεθεί από το ποσό που αποστέλλεται. Ο παραλήπτης θα λάβει λιγότερα bitxs από ό,τι εισάγετε στο πεδίο ποσό. Εάν επιλεγούν πολλοί παραλήπτες, το έξοδο διαιρείται εξίσου.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Υπογράψτε το μήνυμα για να αποδείξετε πως σας ανήκει η συγκεκριμένη διεύθυνση BitX</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Διεύθυνση BitX με την οποία έχει υπογραφεί το μήνυμα</translation>
    </message>
    <message>
        <source>The BitX address to sign the message with</source>
        <translation>Διεύθυνση BitX που θα σταλεί το μήνυμα</translation>
    </message>
    <message>
        <source>The entered address does not refer to a legacy (P2PKH) key. Message signing for SegWit and other non-P2PKH address types is not supported in this version of %1. Please check the address and try again.</source>
        <translation>Η καταχωρημένη διεύθυνση δεν αναφέρεται σε παλαιότερο (P2PKH) κλειδί. Η υπογραφή μηνυμάτων για SegWit και άλλων τύπων διευθύνσεων που δεν είναι P2PKH δεν υποστηρίζεται σε αυτήν την έκδοση του %1. Ελέγξτε τη διεύθυνση και προσπαθήστε ξανά.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Το υπογεγραμμένο μήνυμα προς επιβεβαίωση</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation>Επιβεβαίωση Mηνύματος</translation>
    ...
    <message>
        ...
        <translation>Επαληθεύστε το μήνυμα για να αποδείξετε πως υπογράφθηκε από τη συγκεκριμένη διεύθυνση BitX</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>%1 (Το πιστοποιητικό δεν επαληθεύτηκε)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>0/μη επιβεβαιωμένες, στη mempool</translation>
    </message>
    <message>
        <source>0/unconfirmed, not in memory pool</source>
        <extracomment>Text explaining the current status of a transaction, shown in the status field of the details window for this transaction. This status represents an unconfirmed transaction that is not in the memory pool.</extracomment>
        <translation>0/μη επιβεβαιωμένες, όχι στη mempool</translation>
    </message>
    <message>
        <source>Amount</source>
        <translation>Ποσό</translation>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>ωριμάζει σε %n περισσότερα μπλοκ</numerusform><numerusform>ωριμάζει σε %n περισσότερα μπλοκ</numerusform></translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>&amp;Επεξεργασία της ετικέτας διεύθυνσης</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Α&amp;πόρριψη συναλλαγής</translation>
    </message>
    <message>
        <source>Address</source>
        <translation>Διεύθυνση</translation>
...
-Η-</translation>
    ...
    <message>
        ...
        <translation>Το αρχείο PSBT πρέπει να είναι μικρότερο από 100 MiB</translation>
    </message>
    <message>
        <source>Partially Signed Transaction (*.psbt)</source>
        <translation>Μερικώς υπογεγραμμένη συναλλαγή (*.psbt)</translation>
    </message>
    <message>
        <source>Unable to decode PSBT</source>
        <translation>Αδυναμία στην αποκωδικοποίηση του PSBT</translation>
    </message>
    <message>
        <source>Unable to decode PSBT from clipboard (invalid base64)</source>
        <translation>Αδυναμία αποκωδικοποίησης PSBT από το πρόχειρο (μη έγκυρο Base64)</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Αδυναμία προβολής διεύθυνσης</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>PSBT με αύξηση προμήθειας αντιγράφηκε στο πρόχειρο</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Σφάλμα υπογραφέα</translation>
    </message>
    <message>
        <source>Warning: This may pay the additional fee by reducing change outputs or adding inputs, when necessary. It may add a new change output if one does not already exist. These changes may potentially leak privacy.</source>
        <translation>Προειδοποίηση: Αυτό μπορεί να πληρώσει την πρόσθετη προμήθεια μειώνοντας τις εξόδους ρέστων ή προσθέτοντας εισόδους, όταν είναι απαραίτητο. Μπορεί να προσθέσει μια νέα έξοδο ρέστων εάν δεν υπάρχει ήδη. Αυτές οι αλλαγές ενδέχεται να διαρρεύσουν την ιδιωτικότητα.</translation>
    </message>
</context>
<context>
...
Δεν είναι δυνατή η αποκατάσταση αντιγράφων ασφαλείας του πορτοφολιού.</translation>
    ...
    <message>
        ...
        <translation>%s αίτημα για ακρόαση στη θύρα %u. Αυτή η θύρα θεωρείται "κακή" και επομένως είναι απίθανο ότι κάποιος χρήστης θα συνδεθεί σε αυτή. Δες doc/p2p-bad-ports.md για λεπτομέρειες και μια πλήρης λίστα.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Η επαλήθευση μπλοκ διακόπηκε</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Δεν είναι δυνατή η ρύθμιση -peerblockfilters χωρίς -blockfilterindex.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Θέλετε να επαναδημιουργήσετε τις βάσεις δεδομένων τώρα;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Το αρχείο dump %s δεν υπάρχει.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Σφάλμα κατά τη φόρτωση του %s: Το πορτοφόλι απαιτεί νεότερη έκδοση του %s</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Σφάλμα φόρτωσης βάσεων δεδομένων</translation>
    </message>
    <message>
        <source>Error loading wallet. Wallet requires blocks to be downloaded, and software does not currently support loading wallets while blocks are being downloaded out of order when using assumeutxo snapshots. Wallet should be able to load successfully after node sync reaches height %s</source>
        <translation>Σφάλμα φόρτωσης πορτοφολιού. Το πορτοφόλι απαιτεί λήψη μπλοκ και το λογισμικό δεν υποστηρίζει επί του παρόντος φόρτωση πορτοφολιών, ενώ τα μπλοκ λαμβάνονται εκτός σειράς όταν χρησιμοποιούνται στιγμιότυπα assumeutxo. Το πορτοφόλι θα είναι σε θέση να φορτώσει με επιτυχία αφού ο συγχρονισμός κόμβου φτάσει το ύψος %s</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Σφάλμα ανοίγματος βάσης δεδομένων κερμάτων</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Σφάλμα ανάγνωσης %s! Τα δεδομένα της συναλλαγής ενδέχεται να είναι ελλειπή ή λανθασμένα. Επανεξέταση πορτοφολιού.</translation>
    </message>
    <message>
        <source>Error reading configuration file: %s</source>
        <translation>Σφάλμα ανάγνωσης αρχείου ρυθμίσεων: %s</translation>
    </message>
    <message>
        <source>Error reading from database, shutting down.</source>
        <translation>Σφάλμα ανάγνωσης από τη βάση δεδομένων, εκτελείται τερματισμός.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Σφάλμα: Το checksum του αρχείου dump δεν αντιστοιχεί. Υπολογίστηκε: %s, αναμενόταν: %s</translation>
    </message>
    <message>
        <source>Error: Dumpfile format record is incorrect. Got "%s", expected "format".</source>
        <translation>Σφάλμα: Η καταγραφή του φορμά του αρχείου dump είναι εσφαλμένη. Ελήφθη: «%s», αναμενόταν: «φορμά».</translation>
    </message>
    <message>
        ...
        <translation>Σφάλμα: Η έκδοση του αρχείου dump δεν υποστηρίζεται. Αυτή η έκδοση του bitx-wallet υποστηρίζει αρχεία dump μόνο της έκδοσης 1. Δόθηκε αρχείο dump έκδοσης %s.</translation>
    </message>
    <message>
        <source>Error: Got key that was not hex: %s</source>
        <translation>Σφάλμα: Ελήφθη μη δεκαεξαδικό κλειδί: %s</translation>
    </message>
    <message>
        <source>Error: Got value that was not hex: %s</source>
        <translation>Σφάλμα: Ελήφθη μη δεκαεξαδική τιμή: %s</translation>
    </message>
    <message>
        <source>Error: Missing checksum</source>
        <translation>Σφάλμα: Δεν υπάρχει το checksum</translation>
    </message>
    <message>
        <source>Error: No %s addresses available.</source>
        <translation>Σφάλμα: Δεν υπάρχουν διευθύνσεις %s διαθέσιμες.</translation>
    </message>
    <message>
        <source>Error: Wallet does not exist</source>
        <translation>Σφάλμα: Το πορτοφόλι δεν υπάρχει</translation>
    </message>
    <message>
        <source>Failed to disconnect block.</source>
        <translation>Αποτυχία αποσύνδεσης block.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Αποτυχία ανάγνωσης block.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Αποτυχία εγγραφής block.</translation>
    </message>
    <message>
        <source>Failed to write undo data.</source>
        <translation>Αποτυχία εγγραφής δεδομένων αναίρεσης.</translation>
    </message>
    <message>
        <source>Failure removing transaction: %s</source>
        <translation>Αποτυχία αφαίρεσης συναλλαγής: %s</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Το αρχείο %s υπάρχει ήδη. Αν είστε σίγουροι ότι αυτό θέλετε, βγάλτε το πρώτα από τη μέση.</translation>
    </message>
    <message>
        <source>Ignoring duplicate -wallet %s.</source>
        <translation>Αγνόηση διπλότυπου -wallet %s.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Το input δεν βρέθηκε ή έχει ξοδευτεί</translation>
    </message>
    <message>
        <source>Insufficient dbcache for block verification</source>
        <translation>Ανεπαρκής dbcache για επαλήθευση block</translation>
    </message>
    <message>
        <source>Insufficient funds</source>
        <translation>Ανεπαρκές κεφάλαιο</translation>
    ...
    <message>
        ...
        <translation>Μη έγκυρη διεύθυνση -proxy ή όνομα κεντρικού υπολογιστή, τελειώνει με '=': '%s'</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Μη έγκυρο ποσό για %s=&lt;amount&gt;:'%s'</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Η ακρόαση για εισερχόμενες συνδέσεις απέτυχε (ακούστε επιστραμμένο σφάλμα %s)</translation>
    </message>
    <message>
        <source>Loading P2P addresses…</source>
        <translation>Φόρτωση διευθύνσεων P2P...</translation>
    </message>
    <message>
        <source>Loading banlist…</source>
        <translation>Φόρτωση λίστας απαγόρευσης...</translation>
    </message>
    <message>
        <source>Loading block index…</source>
        <translation>Φόρτωση ευρετηρίου block…</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Έλλειψη ποσού</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Καμμία διαθέσιμη διεύθυνση</translation>
    </message>
    <message>
        <source>No dump file provided. To use createfromdump, -dumpfile=&lt;filename&gt; must be provided.</source>
        <translation>Δεν δόθηκε αρχείο dump. Για να χρησιμοποιηθεί το createfromdump θα πρέπει να δοθεί το -dumpfile=&lt;filename&gt;.</translation>
    </message>
    <message>
        <source>No dump file provided. To use dump, -dumpfile=&lt;filename&gt; must be provided.</source>
        <translation>Δεν δόθηκε αρχείο dump. Για να χρησιμοποιηθεί το dump, πρέπει να δοθεί το -dumpfile=&lt;filename&gt;.</translation>
    </message>
    <message>
        <source>Not found pre-selected input %s</source>
        <translation>Δεν βρέθηκε το προεπιλεγμένο input %s</translation>
    </message>
    <message>
        <source>Not solvable pre-selected input %s</source>
        <translation>Μη επιλύσιμο προεπιλεγμένο input %s</translation>
    </message>
    <message>
        <source>Outbound connections restricted to Tor (-onlynet=onion) but the proxy for reaching the Tor network is explicitly forbidden: -onion=0</source>
        <translation>Εξερχόμενες συνδέσεις περιορίζονται στο Tor (-onlynet=onion) αλλά το proxy για πρόσβαση στο δίκτυο Tor απαγορεύεται ρητά από το: -onion=0</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Η λειτουργία περικοπής χώρου είναι ασύμβατη με το -reindex-chainstate. Χρησιμοποιήστε πλήρες -reindex αντί αυτού.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Εκτελείται περικοπή αποθήκης block...</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Σάρωση εκ νέου...</translation>
    </message>
    <message>
        <source>SQLiteDatabase: Failed to execute statement to verify database: %s</source>
        <translation>SQLite βάση δεδομένων: Απέτυχε η εκτέλεση της δήλωσης για την επαλήθευση της βάσης δεδομένων: %s</translation>
    </message>
    <message>
        <source>SQLiteDatabase: Failed to prepare statement to verify database: %s</source>
        <translation>SQLite βάση δεδομένων: Απέτυχε η προετοιμασία της δήλωσης για την επαλήθευση της βάσης δεδομένων: %s</translation>
    </message>
    <message>
        <source>SQLiteDatabase: Failed to read database verification error: %s</source>
        <translation>SQLite βάση δεδομένων: Απέτυχε η ανάγνωση της επαλήθευσης του σφάλματος της βάσης δεδομένων: %s</translation>
    </message>
    <message>
        <source>SQLiteDatabase: Unexpected application id. Expected %u, got %u</source>
        <translation>SQLiteDatabase: Μη αναμενόμενο αναγνωριστικό εφαρμογής. Αναμενόταν: %u, ελήφθη: %u</translation>
    </message>
    <message>
        <source>SQLiteDatabase: Unknown sqlite wallet schema version %d. Only version %d is supported</source>
        <translation>SQLiteDatabase: Άγνωστη sqlite έκδοση %d του schema πορτοφολιού . Υποστηρίζεται μόνο η έκδοση %d.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Το αρχείο ρυθμίσεων δεν μπόρεσε να διαβαστεί</translation>
    </message>
    <message>
        <source>Settings file could not be written</source>
        <translation>Το αρχείο ρυθμίσεων δεν μπόρεσε να γραφτεί</translation>
    </message>
    <message>
        <source>Signer did not echo address</source>
        <translation>Ο υπογραφέας δεν επανέλαβε τη διεύθυνση</translation>
    </message>
    <message>
        <source>Signer echoed unexpected address %s</source>
        <translation>Ο υπογραφέας επέστρεψε μη αναμενόμενη διεύθυνση %s</translation>
    </message>
    <message>
        <source>Signer returned error: %s</source>
        <translation>Ο υπογραφέας επέστρεψε σφάλμα: %s</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Η ορισμένη -walletdir "%s" δεν υπάρχει</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ο ορισμένος κατάλογος δεδομένων "%s" δεν υπάρχει.</translation>
    </message>
    <message>
        <source>Starting network threads…</source>
        <translation>Εκκίνηση των threads δικτύου...</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ο συνδυασμός των προεπιλεγμένων input και της αυτόματης επιλογής input του πορτοφολιού υπερβαίνει το μέγιστο βάρος συναλλαγής. Παρακαλώ δοκιμάστε να στείλετε μικρότερο ποσό ή συνενώστε χειροκίνητα τα UTXO του πορτοφολιού σας</translation>
    </message>
    <message>
        <source>The inputs size exceeds the maximum weight. Please try sending a smaller amount or manually consolidating your wallet's UTXOs</source>
        <translation>Το μέγεθος των inputs υπερβαίνει το μέγιστο βάρος. Παρακαλώ δοκιμάστε να στείλετε μικρότερο ποσό ή συνενώστε χειροκίνητα τα UTXO του πορτοφολιού σας</translation>
    </message>
    <message>
        <source>The preselected coins total amount does not cover the transaction target. Please allow other inputs to be automatically selected or include more coins manually</source>
        <translation>Το συνολικό ποσό των προεπιλεγμένων κερμάτων δεν καλύπτει τον στόχο της συναλλαγής. Παρακαλώ επιτρέψτε την αυτόματη επιλογή άλλων κερμάτων ή συμπεριλάβετε περισσότερα κέρματα χειροκίνητα</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Το δοθέν αρχείο ρυθμίσεων %s δεν υπάρχει </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Αυτό είναι το μέγιστο τέλος συναλλαγής που πληρώνετε (επιπλέον του κανονικού τέλους) για να δώσετε προτεραιότητα στην αποφυγή μη ολοκληρωμένης δαπάνης έναντι της κανονικής επιλογής κερμάτων.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Δεν είναι δυνατή η δέσμευση του %s σε αυτόν τον υπολογιστή (η δέσμευση επέστρεψε σφάλμα %s)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Αδυναμία στο άνοιγμα του %s για εγγραφή</translation>
    </message>
    <message>
        <source>Unable to parse -maxuploadtarget: '%s'</source>
        <translation>Αδύνατη η ανάλυση του -maxuploadtarget: '%s'</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Υπάρχουν διαθέσιμα μη επιβεβαιωμένα UTXO, αλλά η δαπάνη τους δημιουργεί αλυσίδα συναλλαγών που θα απορριφθεί από το mempool</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ενεργοποιήθηκαν άγνωστοι νέοι κανόνες (bit έκδοσης %i)</translation>
    </message>
    <message>
        <source>Unrecognized network in -proxy='%s': '%s'</source>
        <translation>Μη αναγνωρισμένο δίκτυο στο -proxy='%s': '%s'</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Επαλήθευση των blocks…</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Αποτυχία δημιουργίας αρχείου πορτοφολιού: %s</translation>
    </message>
    <message>
        <source>Warning: Private keys detected in wallet {%s} with disabled private keys</source>
        <translation>Προειδοποίηση: Ιδιωτικά κλειδιά εντοπίστηκαν στο πορτοφόλι {%s} με απενεργοποιημένα ιδιωτικά κλειδιά</translation>
    </message>
    <message>
