...
#ifndef BITX_UTIL_STDMUTEX_H
#define BITX_UTIL_STDMUTEX_H
...
#define STDLOCK(cs) StdMutex::Guard BITX_UNIQUE_NAME(criticalblock){StdMutex::CheckNotHeld(cs)}

#endif // BITX_UTIL_STDMUTEX_H
