 ...
 * visible.
 *
 * See: https://github.com/pull/20272#issuecomment-720755781
 */
...
#define REVERSE_LOCK(g, cs) typename std::decay<decltype(g)>::type::reverse_lock BITX_UNIQUE_NAME(revlock)(g, cs, #cs, __FILE__, __LINE__)
...
#define LOCK(cs) UniqueLock BITX_UNIQUE_NAME(criticalblock)(MaybeCheckNotHeld(cs), #cs, __FILE__, __LINE__)
