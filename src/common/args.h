...
#ifndef BITX_COMMON_ARGS_H
#define BITX_COMMON_ARGS_H
...
extern const char * const BITX_CONF_FILENAME;
extern const char * const BITX_SETTINGS_FILENAME;
