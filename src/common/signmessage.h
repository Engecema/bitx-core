...
#ifndef BITX_COMMON_SIGNMESSAGE_H
#define BITX_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's bitx address, it must refer to a public key.
...
#endif // BITX_COMMON_SIGNMESSAGE_H
