...
#ifndef BITX_CHAINPARAMSBASE_H
#define BITX_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between bitx-cli and bitxd)
 * of a given instance of the BitX system.
 */
