...
#ifndef BITX_INTERFACES_NODE_H
#define BITX_INTERFACES_NODE_H
...
//! Top-level interface for a bitx node (bitxd process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or bitx.conf.
