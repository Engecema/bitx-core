...
{
    const char* pszTimestamp = "BitX Core 20/092026: Sovereign and independent infrastructure protocol";
...
public:
    CMainParams(const MainNetOptions& opts) {
        ...
        genesis = CreateGenesisBlock(1231006505, 32, 0x1d00ffff, 1, 500 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
         assert(consensus.hashGenesisBlock == uint256{"38b658705971262990110024187fdd2af104b1b35dff62d14369fff836cb22b5"});
         assert(genesis.hashMerkleRoot == uint256{"919dd0daa44aeec922463418dfed0be178b218ffe4e7752fd459dcead37c07d2"});
        ...
        vSeeds.emplace_back("seed.bitx.jonasschnelli.ch."); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.btc.petertodd.net."); // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.bitx.sprovoost.nl."); // Sjors Provoost
        vSeeds.emplace_back("dnsseed.emzy.de."); // Stephan Oeste
        vSeeds.emplace_back("seed.bitx.wiz.biz."); // Jason Maurice
...
public:
    CTestNetParams(const TestNetOptions& opts) {
        ...
        vSeeds.emplace_back("testnet-seed.bitx.jonasschnelli.ch.");
...
public:
    CTestNet4Params(const TestNetOptions& opts) {
        ...
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("seed.testnet4.bitx.sprovoost.nl."); // Sjors Provoost
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            ...
            vSeeds.emplace_back("seed.signet.bitx.sprovoost.nl.");
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        genesis = CreateGenesisBlock(1296688602, 2, 0x207fffff, 1, 500 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
         // assert(consensus.hashGenesisBlock == uint256{"9e6df7efff869dbe90785e0e718beea9106675b2f9a0741edf6a5f7eb9df8492"});
         // assert(genesis.hashMerkleRoot == uint256{"4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"});
        ...
        m_assumeutxo_data = {
            ...
            {
                // For use by test/functional/feature_assumeutxo.py and test/functional/tool_bitx_chainstate.py
                .height = 299,
