// Copyright (c) 2024-present The BitX Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITX_KERNEL_BITXKERNEL_H
#define BITX_KERNEL_BITXKERNEL_H
...
#ifndef BITXKERNEL_API
    #ifdef BITXKERNEL_BUILD
        #if defined(_WIN32)
            #define BITXKERNEL_API __declspec(dllexport)
        #else
            #define BITXKERNEL_API __attribute__((visibility("default")))
        #endif
    #else
        #if defined(_WIN32) && !defined(BITXKERNEL_STATIC)
            #define BITXKERNEL_API __declspec(dllimport)
        #else
            #define BITXKERNEL_API
        #endif
    #endif
#endif

/**
 * BITXKERNEL_WARN_UNUSED_RESULT is a compiler attribute used to indicate
 ...
 */
#if defined(__GNUC__)
    #define BITXKERNEL_WARN_UNUSED_RESULT __attribute__((__warn_unused_result__))
#else
    #define BITXKERNEL_WARN_UNUSED_RESULT
#endif

/**
 * BITXKERNEL_ARG_NONNULL is a compiler attribute used to indicate that
 ...
 */
#if !defined(BITXKERNEL_BUILD) && defined(__GNUC__)
    #define BITXKERNEL_ARG_NONNULL(...) __attribute__((__nonnull__(__VA_ARGS__)))
#else
    #define BITXKERNEL_ARG_NONNULL(...)
#endif
 ...
 *
 * This header currently exposes an API for interacting with parts of BitX
 ...
 * also not yet included in releases of BitX Core.
 *
...
/**
 * Function signature for the global logging callback. All bitx kernel
 ...
 */
BITXKERNEL_API btck_TxValidationState* BITXKERNEL_WARN_UNUSED_RESULT btck_tx_validation_state_create();

/**
 * Returns the validation mode from an opaque btck_TxValidationState pointer.
 */
BITXKERNEL_API btck_ValidationMode btck_tx_validation_state_get_validation_mode(
    const btck_TxValidationState* state) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API btck_TxValidationResult btck_tx_validation_state_get_tx_validation_result(
    const btck_TxValidationState* state) BITXKERNEL_ARG_NONNULL(1);

/**
 * Destroy the btck_TxValidationState.
 */
BITXKERNEL_API void btck_tx_validation_state_destroy(btck_TxValidationState* state);
 ...
 */
BITXKERNEL_API btck_Transaction* BITXKERNEL_WARN_UNUSED_RESULT btck_transaction_create(
 ...
 */
BITXKERNEL_API btck_Transaction* BITXKERNEL_WARN_UNUSED_RESULT btck_transaction_copy(
    const btck_Transaction* transaction) BITXKERNEL_ARG_NONNULL(1);
 ...
 * @return                0 on success.
 */
BITXKERNEL_API int BITXKERNEL_WARN_UNUSED_RESULT btck_transaction_to_bytes(
    const btck_Transaction* transaction,
    btck_WriteBytes writer,
    void* user_data) BITXKERNEL_ARG_NONNULL(1, 2);
 ...
 */
BITXKERNEL_API size_t btck_transaction_count_outputs(
    const btck_Transaction* transaction) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API const btck_TransactionOutput* btck_transaction_get_output_at(
    const btck_Transaction* transaction, size_t output_index) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API const btck_TransactionInput* btck_transaction_get_input_at(
    const btck_Transaction* transaction, size_t input_index) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API size_t btck_transaction_count_inputs(
    const btck_Transaction* transaction) BITXKERNEL_ARG_NONNULL(1);
 ...
 * @return                The version.
 */
BITXKERNEL_API uint32_t btck_transaction_get_version(
    const btck_Transaction* transaction) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API uint32_t btck_transaction_get_locktime(
    const btck_Transaction* transaction) BITXKERNEL_ARG_NONNULL(1);
 ...
 * @return                The txid.
 */
BITXKERNEL_API const btck_Txid* btck_transaction_get_txid(
    const btck_Transaction* transaction) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API int btck_transaction_has_witness(
    const btck_Transaction* transaction) BITXKERNEL_ARG_NONNULL(1);
 ...
 * @return                The wtxid.
 */
BITXKERNEL_API const btck_Wtxid* btck_transaction_get_wtxid(
    const btck_Transaction* transaction) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API int btck_transaction_check(
    const btck_Transaction* tx,
    btck_TxValidationState* validation_state) BITXKERNEL_ARG_NONNULL(1, 2);

/**
 * Destroy the transaction.
 */
BITXKERNEL_API void btck_transaction_destroy(btck_Transaction* transaction);
 ...
 */
BITXKERNEL_API btck_PrecomputedTransactionData* BITXKERNEL_WARN_UNUSED_RESULT btck_precomputed_transaction_data_create(
    const btck_Transaction* tx_to,
    const btck_TransactionOutput** spent_outputs, size_t spent_outputs_len) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API btck_PrecomputedTransactionData* BITXKERNEL_WARN_UNUSED_RESULT btck_precomputed_transaction_data_copy(
    const btck_PrecomputedTransactionData* precomputed_txdata) BITXKERNEL_ARG_NONNULL(1);

/**
 * Destroy the precomputed transaction data.
 */
BITXKERNEL_API void btck_precomputed_transaction_data_destroy(btck_PrecomputedTransactionData* precomputed_txdata);
 ...
 */
BITXKERNEL_API btck_ScriptPubkey* BITXKERNEL_WARN_UNUSED_RESULT btck_script_pubkey_create(
 ...
 */
BITXKERNEL_API btck_ScriptPubkey* BITXKERNEL_WARN_UNUSED_RESULT btck_script_pubkey_copy(
    const btck_ScriptPubkey* script_pubkey) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API int BITXKERNEL_WARN_UNUSED_RESULT btck_script_pubkey_verify(
    ...
    btck_ScriptVerifyStatus* status) BITXKERNEL_ARG_NONNULL(1, 3);
 ...
 * @return                  0 on success.
 */
BITXKERNEL_API int BITXKERNEL_WARN_UNUSED_RESULT btck_script_pubkey_to_bytes(
    const btck_ScriptPubkey* script_pubkey,
    btck_WriteBytes writer,
    void* user_data) BITXKERNEL_ARG_NONNULL(1, 2);
 ...
 */
BITXKERNEL_API void btck_script_pubkey_destroy(btck_ScriptPubkey* script_pubkey);
 ...
 * @return                  The transaction output.
 */
BITXKERNEL_API btck_TransactionOutput* BITXKERNEL_WARN_UNUSED_RESULT btck_transaction_output_create(
    const btck_ScriptPubkey* script_pubkey,
    int64_t amount) BITXKERNEL_ARG_NONNULL(1);
 ...
 * @return                       The script pubkey.
 */
BITXKERNEL_API const btck_ScriptPubkey* btck_transaction_output_get_script_pubkey(
    const btck_TransactionOutput* transaction_output) BITXKERNEL_ARG_NONNULL(1);
 ...
 * @return                       The amount.
 */
BITXKERNEL_API int64_t btck_transaction_output_get_amount(
    const btck_TransactionOutput* transaction_output) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API btck_TransactionOutput* BITXKERNEL_WARN_UNUSED_RESULT btck_transaction_output_copy(
    const btck_TransactionOutput* transaction_output) BITXKERNEL_ARG_NONNULL(1);

/**
 * Destroy the transaction output.
 */
BITXKERNEL_API void btck_transaction_output_destroy(btck_TransactionOutput* transaction_output);
 ...
 * already exists.
 */
BITXKERNEL_API void btck_logging_disable();
 ...
 */
BITXKERNEL_API void btck_logging_set_options(btck_LoggingOptions options);
 ...
 */
BITXKERNEL_API void btck_logging_set_level_category(btck_LogCategory category, btck_LogLevel level);
 ...
 */
BITXKERNEL_API void btck_logging_enable_category(btck_LogCategory category);
 ...
 */
BITXKERNEL_API void btck_logging_disable_category(btck_LogCategory category);
 ...
 */
BITXKERNEL_API btck_LoggingConnection* BITXKERNEL_WARN_UNUSED_RESULT btck_logging_connection_create(
    btck_LogCallback log_callback,
    void* user_data,
    btck_DestroyCallback user_data_destroy_callback) BITXKERNEL_ARG_NONNULL(1);

/**
 * Stop logging and destroy the logging connection.
 */
BITXKERNEL_API void btck_logging_connection_destroy(btck_LoggingConnection* logging_connection);
 ...
 */
BITXKERNEL_API btck_ChainParameters* BITXKERNEL_WARN_UNUSED_RESULT btck_chain_parameters_create(
 ...
 * @return                  An allocated chain parameters opaque struct.
 */
BITXKERNEL_API btck_ChainParameters* BITXKERNEL_WARN_UNUSED_RESULT btck_chain_parameters_create_signet(
    const void* challenge, size_t challenge_len);

/**
 * Copy the chain parameters.
 */
BITXKERNEL_API btck_ChainParameters* BITXKERNEL_WARN_UNUSED_RESULT btck_chain_parameters_copy(
    const btck_ChainParameters* chain_parameters) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API const btck_ConsensusParams* btck_chain_parameters_get_consensus_params(
    const btck_ChainParameters* chain_parameters) BITXKERNEL_ARG_NONNULL(1);

/**
 * Destroy the chain parameters.
 */
BITXKERNEL_API void btck_chain_parameters_destroy(btck_ChainParameters* chain_parameters);
 ...
 */
BITXKERNEL_API btck_ContextOptions* BITXKERNEL_WARN_UNUSED_RESULT btck_context_options_create();
 ...
 */
BITXKERNEL_API void btck_context_options_set_chainparams(
    btck_ContextOptions* context_options,
    const btck_ChainParameters* chain_parameters) BITXKERNEL_ARG_NONNULL(1, 2);
 ...
 */
BITXKERNEL_API void btck_context_options_set_notifications(
    btck_ContextOptions* context_options,
    btck_NotificationInterfaceCallbacks notifications) BITXKERNEL_ARG_NONNULL(1);
 ...
 *                                           user.
 */
BITXKERNEL_API void btck_context_options_set_validation_interface(
    btck_ContextOptions* context_options,
    btck_ValidationInterfaceCallbacks validation_interface_callbacks) BITXKERNEL_ARG_NONNULL(1);

/**
 * Destroy the context options.
 */
BITXKERNEL_API void btck_context_options_destroy(btck_ContextOptions* context_options);
 ...
 */
BITXKERNEL_API btck_Context* BITXKERNEL_WARN_UNUSED_RESULT btck_context_create(
    const btck_ContextOptions* context_options);

/**
 * Copy the context.
 */
BITXKERNEL_API btck_Context* BITXKERNEL_WARN_UNUSED_RESULT btck_context_copy(
    const btck_Context* context) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API int BITXKERNEL_WARN_UNUSED_RESULT btck_context_interrupt(
    btck_Context* context) BITXKERNEL_ARG_NONNULL(1);

/**
 * Destroy the context.
 */
BITXKERNEL_API void btck_context_destroy(btck_Context* context);
 ...
 */
BITXKERNEL_API const btck_BlockTreeEntry* btck_block_tree_entry_get_previous(
    const btck_BlockTreeEntry* block_tree_entry) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API btck_BlockHeader* BITXKERNEL_WARN_UNUSED_RESULT btck_block_tree_entry_get_block_header(
    const btck_BlockTreeEntry* block_tree_entry) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API int32_t btck_block_tree_entry_get_height(
    const btck_BlockTreeEntry* block_tree_entry) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API const btck_BlockHash* btck_block_tree_entry_get_block_hash(
    const btck_BlockTreeEntry* block_tree_entry) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API int btck_block_tree_entry_equals(
    const btck_BlockTreeEntry* entry1, const btck_BlockTreeEntry* entry2) BITXKERNEL_ARG_NONNULL(1, 2);
 ...
 */
BITXKERNEL_API const btck_BlockTreeEntry* btck_block_tree_entry_get_ancestor(
    const btck_BlockTreeEntry* block_tree_entry,
    int32_t height) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API btck_ChainstateManagerOptions* BITXKERNEL_WARN_UNUSED_RESULT btck_chainstate_manager_options_create(
    const btck_Context* context,
    const char* data_directory,
    size_t data_directory_len,
    const char* blocks_directory,
    size_t blocks_directory_len) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API void btck_chainstate_manager_options_set_worker_threads_num(
    btck_ChainstateManagerOptions* chainstate_manager_options,
    int worker_threads) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API int BITXKERNEL_WARN_UNUSED_RESULT btck_chainstate_manager_options_set_database_cache_bytes(
    btck_ChainstateManagerOptions* chainstate_manager_options,
    uint64_t database_cache_bytes) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API int BITXKERNEL_WARN_UNUSED_RESULT btck_chainstate_manager_options_set_wipe_dbs(
    btck_ChainstateManagerOptions* chainstate_manager_options,
    int wipe_block_tree_db,
    int wipe_chainstate_db) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API void btck_chainstate_manager_options_update_block_tree_db_in_memory(
    btck_ChainstateManagerOptions* chainstate_manager_options,
    int block_tree_db_in_memory) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API void btck_chainstate_manager_options_update_chainstate_db_in_memory(
    btck_ChainstateManagerOptions* chainstate_manager_options,
    int chainstate_db_in_memory) BITXKERNEL_ARG_NONNULL(1);

/**
 * Destroy the chainstate manager options.
 */
BITXKERNEL_API void btck_chainstate_manager_options_destroy(btck_ChainstateManagerOptions* chainstate_manager_options);
 ...
 */
BITXKERNEL_API btck_ChainstateManager* BITXKERNEL_WARN_UNUSED_RESULT btck_chainstate_manager_create(
    const btck_ChainstateManagerOptions* chainstate_manager_options) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API const btck_BlockTreeEntry* btck_chainstate_manager_get_best_entry(
    const btck_ChainstateManager* chainstate_manager) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API btck_BlockValidationState* BITXKERNEL_WARN_UNUSED_RESULT btck_chainstate_manager_process_block_header(
    btck_ChainstateManager* chainstate_manager,
    const btck_BlockHeader* header) BITXKERNEL_ARG_NONNULL(1, 2);
 ...
 */
BITXKERNEL_API int BITXKERNEL_WARN_UNUSED_RESULT btck_chainstate_manager_import_blocks(
    btck_ChainstateManager* chainstate_manager,
    const char** block_file_paths_data, size_t* block_file_paths_lens,
    size_t block_file_paths_data_len) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API int BITXKERNEL_WARN_UNUSED_RESULT btck_chainstate_manager_process_block(
    btck_ChainstateManager* chainstate_manager,
    const btck_Block* block,
    int* new_block) BITXKERNEL_ARG_NONNULL(1, 2, 3);
 ...
 * @return                       The chain.
 */
BITXKERNEL_API const btck_Chain* btck_chainstate_manager_get_active_chain(
    const btck_ChainstateManager* chainstate_manager) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API const btck_BlockTreeEntry* btck_chainstate_manager_get_block_tree_entry_by_hash(
    const btck_ChainstateManager* chainstate_manager,
    const btck_BlockHash* block_hash) BITXKERNEL_ARG_NONNULL(1, 2);

/**
 * Destroy the chainstate manager.
 */
BITXKERNEL_API void btck_chainstate_manager_destroy(btck_ChainstateManager* chainstate_manager);
 ...
 */
BITXKERNEL_API btck_Block* BITXKERNEL_WARN_UNUSED_RESULT btck_block_read(
    const btck_ChainstateManager* chainstate_manager,
    const btck_BlockTreeEntry* block_tree_entry) BITXKERNEL_ARG_NONNULL(1, 2);
 ...
 */
BITXKERNEL_API btck_Block* BITXKERNEL_WARN_UNUSED_RESULT btck_block_create(
 ...
 */
BITXKERNEL_API btck_Block* BITXKERNEL_WARN_UNUSED_RESULT btck_block_copy(
    const btck_Block* block) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API int btck_block_check(
    const btck_Block* block,
    const btck_ConsensusParams* consensus_params,
    btck_BlockCheckFlags flags,
    btck_BlockValidationState* validation_state) BITXKERNEL_ARG_NONNULL(1, 2, 4);
 ...
 */
BITXKERNEL_API size_t btck_block_count_transactions(
    const btck_Block* block) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API const btck_Transaction* btck_block_get_transaction_at(
    const btck_Block* block, size_t transaction_index) BITXKERNEL_ARG_NONNULL(1);
 ...
 * @return          btck_BlockHeader.
 */
BITXKERNEL_API btck_BlockHeader* BITXKERNEL_WARN_UNUSED_RESULT btck_block_get_header(
    const btck_Block* block) BITXKERNEL_ARG_NONNULL(1);
 ...
 * @return    The block hash.
 */
BITXKERNEL_API btck_BlockHash* BITXKERNEL_WARN_UNUSED_RESULT btck_block_get_hash(
    const btck_Block* block) BITXKERNEL_ARG_NONNULL(1);
 ...
 * @return              0 on success.
 */
BITXKERNEL_API int BITXKERNEL_WARN_UNUSED_RESULT btck_block_to_bytes(
    const btck_Block* block,
    btck_WriteBytes writer,
    void* user_data) BITXKERNEL_ARG_NONNULL(1, 2);
 ...
 * Destroy the block.
 */
BITXKERNEL_API void btck_block_destroy(btck_Block* block);
 ...
 */
BITXKERNEL_API btck_BlockValidationState* BITXKERNEL_WARN_UNUSED_RESULT btck_block_validation_state_create();

/**
 * Returns the validation mode from an opaque btck_BlockValidationState pointer.
 */
BITXKERNEL_API btck_ValidationMode btck_block_validation_state_get_validation_mode(
    const btck_BlockValidationState* block_validation_state) BITXKERNEL_ARG_NONNULL(1);

/**
 * Returns the validation result from an opaque btck_BlockValidationState pointer.
 */
BITXKERNEL_API btck_BlockValidationResult btck_block_validation_state_get_block_validation_result(
    const btck_BlockValidationState* block_validation_state) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API btck_BlockValidationState* BITXKERNEL_WARN_UNUSED_RESULT btck_block_validation_state_copy(
    const btck_BlockValidationState* block_validation_state) BITXKERNEL_ARG_NONNULL(1);

/**
 * Destroy the btck_BlockValidationState.
 */
BITXKERNEL_API void btck_block_validation_state_destroy(
 ...
 */
BITXKERNEL_API int32_t btck_chain_get_height(
    const btck_Chain* chain) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API const btck_BlockTreeEntry* btck_chain_get_by_height(
    const btck_Chain* chain,
    int32_t block_height) BITXKERNEL_ARG_NONNULL(1);
 ...
 *
 */
BITXKERNEL_API int btck_chain_contains(
    const btck_Chain* chain,
    const btck_BlockTreeEntry* block_tree_entry) BITXKERNEL_ARG_NONNULL(1, 2);
 ...
 */
BITXKERNEL_API btck_BlockSpentOutputs* BITXKERNEL_WARN_UNUSED_RESULT btck_block_spent_outputs_read(
    const btck_ChainstateManager* chainstate_manager,
    const btck_BlockTreeEntry* block_tree_entry) BITXKERNEL_ARG_NONNULL(1, 2);
 ...
 */
BITXKERNEL_API btck_BlockSpentOutputs* BITXKERNEL_WARN_UNUSED_RESULT btck_block_spent_outputs_copy(
    const btck_BlockSpentOutputs* block_spent_outputs) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API size_t btck_block_spent_outputs_count(
    const btck_BlockSpentOutputs* block_spent_outputs) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API const btck_TransactionSpentOutputs* btck_block_spent_outputs_get_transaction_spent_outputs_at(
    const btck_BlockSpentOutputs* block_spent_outputs,
    size_t transaction_spent_outputs_index) BITXKERNEL_ARG_NONNULL(1);

/**
 * Destroy the block spent outputs.
 */
BITXKERNEL_API void btck_block_spent_outputs_destroy(btck_BlockSpentOutputs* block_spent_outputs);
 ...
 */
BITXKERNEL_API btck_TransactionSpentOutputs* BITXKERNEL_WARN_UNUSED_RESULT btck_transaction_spent_outputs_copy(
    const btck_TransactionSpentOutputs* transaction_spent_outputs) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API size_t btck_transaction_spent_outputs_count(
    const btck_TransactionSpentOutputs* transaction_spent_outputs) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API const btck_Coin* btck_transaction_spent_outputs_get_coin_at(
    const btck_TransactionSpentOutputs* transaction_spent_outputs,
    size_t coin_index) BITXKERNEL_ARG_NONNULL(1);

/**
 * Destroy the transaction spent outputs.
 */
BITXKERNEL_API void btck_transaction_spent_outputs_destroy(btck_TransactionSpentOutputs* transaction_spent_outputs);
 ...
 */
BITXKERNEL_API btck_TransactionInput* BITXKERNEL_WARN_UNUSED_RESULT btck_transaction_input_copy(
    const btck_TransactionInput* transaction_input) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API const btck_TransactionOutPoint* btck_transaction_input_get_out_point(
    const btck_TransactionInput* transaction_input) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API uint32_t btck_transaction_input_get_sequence(
    const btck_TransactionInput* transaction_input) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API const btck_WitnessStack* btck_transaction_input_get_witness_stack(
    const btck_TransactionInput* transaction_input) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API int BITXKERNEL_WARN_UNUSED_RESULT btck_transaction_input_get_script_sig(
 ...
 */
BITXKERNEL_API void btck_transaction_input_destroy(btck_TransactionInput* transaction_input);
 ...
 */
BITXKERNEL_API size_t btck_witness_stack_count_items(
    const btck_WitnessStack* witness_stack) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API int BITXKERNEL_WARN_UNUSED_RESULT btck_witness_stack_get_item_at(
    const btck_WitnessStack* witness_stack,
    size_t index,
    btck_WriteBytes writer,
    void* user_data) BITXKERNEL_ARG_NONNULL(1, 3);
 ...
 */
BITXKERNEL_API btck_WitnessStack* BITXKERNEL_WARN_UNUSED_RESULT btck_witness_stack_copy(
    const btck_WitnessStack* witness_stack) BITXKERNEL_ARG_NONNULL(1);

/**
 * Destroy the witness stack.
 */
BITXKERNEL_API void btck_witness_stack_destroy(btck_WitnessStack* witness_stack);
 ...
 */
BITXKERNEL_API btck_TransactionOutPoint* BITXKERNEL_WARN_UNUSED_RESULT btck_transaction_out_point_copy(
    const btck_TransactionOutPoint* transaction_out_point) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API uint32_t btck_transaction_out_point_get_index(
    const btck_TransactionOutPoint* transaction_out_point) BITXKERNEL_ARG_NONNULL(1);
 ...
 * @return                          The txid.
 */
BITXKERNEL_API const btck_Txid* btck_transaction_out_point_get_txid(
    const btck_TransactionOutPoint* transaction_out_point) BITXKERNEL_ARG_NONNULL(1);

/**
 * Destroy the transaction out point.
 */
BITXKERNEL_API void btck_transaction_out_point_destroy(btck_TransactionOutPoint* transaction_out_point);
 ...
 */
BITXKERNEL_API btck_Txid* BITXKERNEL_WARN_UNUSED_RESULT btck_txid_copy(
    const btck_Txid* txid) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API int btck_txid_equals(
    const btck_Txid* txid1, const btck_Txid* txid2) BITXKERNEL_ARG_NONNULL(1, 2);
 ...
 */
BITXKERNEL_API void btck_txid_to_bytes(
    const btck_Txid* txid, unsigned char output[32]) BITXKERNEL_ARG_NONNULL(1, 2);

/**
 * Destroy the txid.
 */
BITXKERNEL_API void btck_txid_destroy(btck_Txid* txid);
 ...
 */
BITXKERNEL_API btck_Wtxid* BITXKERNEL_WARN_UNUSED_RESULT btck_wtxid_copy(
    const btck_Wtxid* wtxid) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API int btck_wtxid_equals(
    const btck_Wtxid* wtxid1, const btck_Wtxid* wtxid2) BITXKERNEL_ARG_NONNULL(1, 2);
 ...
 */
BITXKERNEL_API void btck_wtxid_to_bytes(
    const btck_Wtxid* wtxid, unsigned char output[32]) BITXKERNEL_ARG_NONNULL(1, 2);

/**
 * Destroy the wtxid.
 */
BITXKERNEL_API void btck_wtxid_destroy(btck_Wtxid* wtxid);
 ...
 */
BITXKERNEL_API btck_Coin* BITXKERNEL_WARN_UNUSED_RESULT btck_coin_copy(
    const btck_Coin* coin) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API uint32_t btck_coin_confirmation_height(
    const btck_Coin* coin) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API int btck_coin_is_coinbase(
    const btck_Coin* coin) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API const btck_TransactionOutput* btck_coin_get_output(
    const btck_Coin* coin) BITXKERNEL_ARG_NONNULL(1);

/**
 * Destroy the coin.
 */
BITXKERNEL_API void btck_coin_destroy(btck_Coin* coin);
 ...
 */
BITXKERNEL_API btck_BlockHash* BITXKERNEL_WARN_UNUSED_RESULT btck_block_hash_create(
    const unsigned char block_hash[32]) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API int btck_block_hash_equals(
    const btck_BlockHash* hash1, const btck_BlockHash* hash2) BITXKERNEL_ARG_NONNULL(1, 2);
 ...
 */
BITXKERNEL_API btck_BlockHash* BITXKERNEL_WARN_UNUSED_RESULT btck_block_hash_copy(
    const btck_BlockHash* block_hash) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API void btck_block_hash_to_bytes(
    const btck_BlockHash* block_hash, unsigned char output[32]) BITXKERNEL_ARG_NONNULL(1, 2);

/**
 * Destroy the block hash.
 */
BITXKERNEL_API void btck_block_hash_destroy(btck_BlockHash* block_hash);
 ...
 */
BITXKERNEL_API btck_BlockHeader* BITXKERNEL_WARN_UNUSED_RESULT btck_block_header_create(
    const void* raw_block_header, size_t raw_block_header_len) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API btck_BlockHeader* BITXKERNEL_WARN_UNUSED_RESULT btck_block_header_copy(
    const btck_BlockHeader* header) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API btck_BlockHash* BITXKERNEL_WARN_UNUSED_RESULT btck_block_header_get_hash(
    const btck_BlockHeader* header) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API const btck_BlockHash* btck_block_header_get_prev_hash(
    const btck_BlockHeader* header) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API void btck_block_header_get_merkle_root(
    const btck_BlockHeader* header, unsigned char output[32]) BITXKERNEL_ARG_NONNULL(1, 2);
 ...
 */
BITXKERNEL_API uint32_t btck_block_header_get_timestamp(
    const btck_BlockHeader* header) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API uint32_t btck_block_header_get_bits(
    const btck_BlockHeader* header) BITXKERNEL_ARG_NONNULL(1);
 ...
 */
BITXKERNEL_API int32_t btck_block_header_get_version(
    const btck_BlockHeader* header) BITXKERNEL_ARG_NONNULL(1);
 ...
 * @return              Nonce
 */
BITXKERNEL_API uint32_t btck_block_header_get_nonce(
    const btck_BlockHeader* header) BITXKERNEL_ARG_NONNULL(1);
 ...
 * @return              0 on success.
 */
BITXKERNEL_API int BITXKERNEL_WARN_UNUSED_RESULT btck_block_header_to_bytes(
    const btck_BlockHeader* header, unsigned char output[80]) BITXKERNEL_ARG_NONNULL(1, 2);

/**
 * Destroy the btck_BlockHeader.
 */
BITXKERNEL_API void btck_block_header_destroy(btck_BlockHeader* header);
 ...
 */
BITXKERNEL_API int BITXKERNEL_WARN_UNUSED_RESULT btck_set_mock_time(int64_t timestamp);
...
#endif // BITX_KERNEL_BITXKERNEL_H
