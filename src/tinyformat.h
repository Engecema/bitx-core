...
#include <algorithm>
#include <attributes.h> // Added for BitX Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for BitX Core
#include <util/string.h> // Added for BitX Core
...
// Added for BitX Core. Similar to std::runtime_format from C++26.
...
// Added for BitX Core. Wrapper for checking format strings at compile time.
