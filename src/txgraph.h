...
#ifndef BITX_TXGRAPH_H
#define BITX_TXGRAPH_H
 ...
 *
 * For more explanation, see https://delvingbitx.org/t/introduction-to-cluster-linearization/1032
 *
