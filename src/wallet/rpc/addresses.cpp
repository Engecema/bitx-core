...
RPCMethod getnewaddress()
{
    return RPCMethod{
        "getnewaddress",
        "Returns a new BitX address for receiving payments.\n"
                ...
                RPCResult{
                    RPCResult::Type::STR, "address", "The new bitx address"
                },
                RPCExamples{
...
RPCMethod getrawchangeaddress()
{
    return RPCMethod{
        "getrawchangeaddress",
        "Returns a new BitX address, for receiving change.\n"
...
RPCMethod setlabel()
{
    return RPCMethod{
        ...
        "Sets the label associated with the given address.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The bitx address to be associated with a label."},
        ...
        [](const RPCMethod& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (!IsValidDestination(dest)) {
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid BitX address");
    }
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::ARR, "", "",
                        {
                            ...
                            {
                                {RPCResult::Type::STR, "address", "The bitx address"},
...
{
    return {
        {RPCResult::Type::STR, "address", /*optional=*/true, "The bitx address of the embedded script."},
...
RPCMethod getaddressinfo()
{
    return RPCMethod{
        "getaddressinfo",
        "Return information about the given bitx address.\n"
                "Some of the information will only be present if the address is in the active wallet.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The bitx address for which to get information."},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        {RPCResult::Type::STR, "address", "The bitx address validated."},
...
RPCMethod walletdisplayaddress()
{
    return RPCMethod{
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "bitx address to display"},
        },
        RPCResult{
            RPCResult::Type::OBJ,"","",
            {
