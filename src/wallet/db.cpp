        ...
        try {
            ...
            if (it->status().type() == fs::file_type::directory) {
                ...
                if (it->path().filename() == "wallet.dat") {
                    ...
                    // Found top-level btree file not called wallet.dat. Current bitx
...
bool IsBDBFile(const fs::path& path)
{
    ...
    //  httpshttps://github.com/file/file/blob/5824af38469ec1ca9ac3ffd251e7afe9dc11e227/magic/Magdir/database#L74-L75
