...
#ifndef BITX_WALLET_WALLETUTIL_H
#define BITX_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! bitx from opening the wallet, thinking it was newly created, and
...
#endif // BITX_WALLET_WALLETUTIL_H
