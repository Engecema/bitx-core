BitX Core version 27.0 is now available from:

  <https://bitxcore.org/bin/bitx-core-27.0/>
...
- libbitxconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libbitxkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build BitX Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of BitX Core would
