...
BitX Core version v30.3 is now available from:

  <https://bitxcore.org/bin/bitx-core-30.3/>
...
- #61(bitx-core/leveldb): Disable seek compaction
...
- #34608 test: Fix broken --valgrind handling after bitx wrapper
...
- #35080 test: Add missing self.options.timeout_factor scale in tool_bitx_chainstate.py
