BitX-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitx/files/BitX/bitx-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BitX
...
New/changed settings (command-line or bitx.conf file)
--------------------------------------------------------
