BitX Core version 0.16.1 is now available from:

  <https://bitxcore.org/bin/bitx-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitxd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitxd processes are cleaned up when tests end (sdaftuar)
