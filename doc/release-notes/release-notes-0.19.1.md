...
BitX Core version 0.19.1 is now available from:

  <https://bitxcore.org/bin/bitx-core-0.19.1/>
...
From BitX Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as BitX Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, BitX Core does not yet change appearance when
...
- #17488 fix "bitxd already running" warnings on macOS (fanquake)
