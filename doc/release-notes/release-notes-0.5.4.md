BitX version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitx/files/BitX/bitx-0.5.4/
...
http://gitorious.org/bitx/bitxd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BitX-Qt notifications under Growl 1.3.
Increase required age of BitX-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitX properly when installing BitX-Qt over it. (Windows)
