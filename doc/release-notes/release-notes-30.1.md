...
BitX Core version v30.1 is now available from:

  <https://bitxcore.org/bin/bitx-core-30.1/>
...
- #33229 multiprocess: Don't require bitx -m argument when IPC options are used
...
- #33723 chainparams: remove dnsseed.bitx.dashjr-list-of-p2p-nodes.us
