BitX Core version 0.9.4 is now available from:

  https://bitx.org/bin/0.9.4/
...
this update is incompatible with the BitX system and could lead to consensus
forks.

BitX Core released binaries from https://bitx.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitx/+archive/ubuntu/bitx
- A third-party or self-compiled BitX Core

upgrade to BitX Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
