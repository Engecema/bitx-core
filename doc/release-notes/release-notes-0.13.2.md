BitX Core version 0.13.2 is now available from:

  <https://bitx.org/bin/bitx-core-0.13.2/>
...
- #8908 `4a974b2` Update bitx-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitx-tx to create v2 transactions (btcdrak)
