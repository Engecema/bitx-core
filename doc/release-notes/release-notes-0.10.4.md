BitX Core version 0.10.4 is now available from:

  <https://bitx.org/bin/bitx-core-0.10.4/>
...
- #6953 `43c2789` Split bitx-tx into its own package
- #6953 `dfe0d4d` Include bitx-tx binary on Debian/Ubuntu
