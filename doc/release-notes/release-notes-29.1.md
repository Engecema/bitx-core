BitX Core version 29.1 is now available from:

  <https://bitxcore.org/bin/bitx-core-29.1/>
...
- #32389 doc: Fix test_bitx path
- #32607 rpc: Note in fundrawtransaction doc, fee rate is for package
- #32679 doc: update tor docs to use bitxd binary from path
...
- #32719 doc, windows: CompanyName "BitX" => "BitX Core project"
