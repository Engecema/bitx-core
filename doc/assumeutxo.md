...
Assumeutxo is a feature that allows fast bootstrapping of a validating bitxd
instance.
...
```
$ bitx-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ bitx-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
