...
By default, BitX Core allows up to 200 connections to different peers, 11 of
...
limits are tiny. Keep in mind that bitx's trustless model works best if you are
