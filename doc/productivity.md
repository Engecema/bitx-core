...
```sh
cmake --build build --target bitxd bitx-cli
cmake --build build --target bitx-qt
cmake --build build --target bench_bitx
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:bitx/bitx.git
```
...
> e.g. github.com/bitx/bitx.git or for the GUI github.com/bitx-core/gui
