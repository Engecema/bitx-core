# PSBT Howto for BitX Core

Since BitX Core 0.17, an RPC interface exists for Partially Signed BitX
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/bitx/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for BitX transactions that are not fully signed
...
#### Multisig with multiple BitX Core instances
