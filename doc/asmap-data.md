...
but BitX Core also embeds a default map in its builds to make the feature
...
matches with other users' results. Before the map is usable by BitX Core
...
This process is regularly coordinated at the [asmap-data](https://github.com/bitx-core/asmap-data)
...
repository. On startup, `bitxd` logs the version of the ASMap it is using:
